...
profiler config = concatMap (dropWhile isSpace)
 ...
 , "    }; "
 , "  }; "
 , "  var gather = function(sorter, count) { "
 , "    var result = "
 ...
 , "    global.sjsp__result_time = gather(function(x, y) { return y.time - x.time; }, 20); "
 , "    global.sjsp__result_count = gather(function(x, y) { return y.count - x.count; }, 20); "
